...
for qubit in range(qc.num_qubits):
    if qubit not in qubits:
        ...
        valid_node = 0
if valid_node == 1:
    gate_app, circ = distributed.DistributedCircuits(qc, nodes).create_circuit()
    circ.measure_all()
...
gate_app, circ = distributed.CreateDistributedCircuits(qc, c, circ, comm, nodes, 1).create_circuit()
circ.measure_all()
hist_dict = get_hist(circ, qc.num_qubits, n_shots)
print("Result:", hist_dict)